        ...
        <>
            <View style={{ paddingHorizontal: 16, paddingVertical: 12, backgroundColor: "#f8fafc", borderTopWidth: 1, borderTopColor: '#e2e8f0', gap: 8 }}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', }}>
                    ...
                    <Text style={{ flex: 1, fontSize: 14, color: '#334155', textAlign: 'right', fontFamily: 'Opensans-Bold' }}>Rp {formatNumber(40000)}</Text>
                </View>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                    <Text style={{ flex: 1, fontSize: 14, color: '#64748b', fontFamily: 'Opensans-Medium' }}>Tax (10%)</Text>
                    <Text style={{ flex: 1, fontSize: 14, textAlign: 'right', color: '#334155', fontFamily: 'Opensans-Bold' }}>Rp {formatNumber(4000)}</Text>
                </View>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', }}>
                    ...
                    <Text style={{ flex: 1, textAlign: 'right', fontFamily: 'Opensans-ExtraBold', fontSize: 30, color: '#137fec' }}>Rp {formatNumber(43000)}</Text>
                </View>
